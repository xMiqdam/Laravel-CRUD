  ...
  <ul class="space-y-2">
    ...
    <li>
      ...
      <ul id="dropdown-pages" class="hidden py-2 space-y-2">
        <li>
            <x-side-link href="/student-admin" :active="request()->is('student-admin')">Student</x-side-link>

        </li>
        <li>
            <x-side-link href="/grade-admin" :active="request()->is('grade-admin')">Grade</x-side-link>
        </li>
        <li>
            <x-side-link href="/department-admin" :active="request()->is('department-admin')">Department</x-side-link>
        </li>
      </ul>
    </li>
    <li>
